...
mapboxgl.accessToken =
  'pk.eyJ1IjoiZWR1YXJkb2xpbWEiLCJhIjoiY2xkdm42azJxMGhicDNvbnU3Ymx0eXR0cCJ9.RmibGChAoZjxPYmMAvF8tA'

const map = new mapboxgl.Map({
  container: 'map',
  style: 'mapbox://styles/mapbox/light-v10',
  zoom: 20.5,
  center: [-45.87186299387193, -23.209813332199715],
  pitch: 75,
  bearing: -80,
  antialias: true,
})

const modelOrigin = [-45.87186299387193, -23.209813332199715]
const modelAltitude = 0
const modelRotate = [Math.PI / 2, 4, 0]
